...
def test_get_list(channel_admin, commission):
...
@pytest.mark.django_db
def test_create_commission(channel_admin, commission_create_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_update_commission(channel_admin, commission, commission_update_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_partial_update_commission(
