...
def test_get_list(channel_admin, margin):
...
@pytest.mark.django_db
def test_create_margin(channel_admin, margin_create_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_update_margin(channel_admin, margin, margin_update_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_partial_update_margin(channel_admin, margin, margin_update_request):
    client.set_user(channel_admin)
