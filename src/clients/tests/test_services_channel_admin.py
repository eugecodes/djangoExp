...
def test_create_client_channel_admin(channel_admin, client_create_request):
    new_client = client_create(client_create_request, channel_admin)
...
@pytest.mark.django_db
def test_update_client_channel_admin(
    channel_admin, channel_client, client_update_request
):
    updatable_client = client_update(
        channel_client, client_update_request, channel_admin
    )
