...
def test_get_list(channel_admin, invoice):
...
@pytest.mark.django_db
def test_create_invoice(channel_admin, invoice_create_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_update_invoice(channel_admin, invoice, invoice_update_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_partial_update_invoice(channel_admin, invoice, invoice_update_request):
    client.set_user(channel_admin)
