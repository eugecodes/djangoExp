...
def test_get_list(channel_admin, {{ cookiecutter.app_slug }}):
...
@pytest.mark.django_db
def test_create_{{ cookiecutter.app_slug }}(channel_admin, {{ cookiecutter.app_slug }}_create_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_update_{{ cookiecutter.app_slug }}(channel_admin, {{ cookiecutter.app_slug }}, {{ cookiecutter.app_slug }}_update_request):
    client.set_user(channel_admin)
...
@pytest.mark.django_db
def test_partial_update_{{ cookiecutter.app_slug }}(channel_admin, {{ cookiecutter.app_slug }}, {{ cookiecutter.app_slug }}_update_request):
    client.set_user(channel_admin)
