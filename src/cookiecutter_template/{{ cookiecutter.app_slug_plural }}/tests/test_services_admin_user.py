...
def test_create_{{ cookiecutter.app_slug }}_admin_user(admin_user, {{ cookiecutter.app_slug }}_create_request):
    new_{{ cookiecutter.app_slug }} = {{ cookiecutter.app_slug }}_create({{ cookiecutter.app_slug }}_create_request, admin_user)
...
def test_update_{{ cookiecutter.app_slug }}_admin_user(admin_user, {{ cookiecutter.app_slug }}, {{ cookiecutter.app_slug }}_update_request):
    updatable_{{ cookiecutter.app_slug }} = {{ cookiecutter.app_slug }}_update({{ cookiecutter.app_slug }}, {{ cookiecutter.app_slug }}_update_request, admin_user)
